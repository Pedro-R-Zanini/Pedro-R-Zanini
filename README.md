...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/API_REST-005571?style=for-the-badge&logo=json&logoColor=white" />
</p>
...
* **[Agente de IA Autônomo (n8n + Gemini)](#)**: Arquitetura de "Dois Cérebros" operando via WhatsApp, com memória permanente autogerenciável e separação total entre dados de registro e contexto da IA. Integrado a PostgreSQL e Tavily API para buscas em tempo real.
* **[SnowWalletKMP](https://github.com/Pedro-R-Zanini/SnowWalletKMP)**: Carteira digital focada no compartilhamento de regras de negócios e arquitetura limpa entre múltiplas plataformas utilizando Kotlin Multiplatform.
* **[GabizitaPlayer-Android-TV](https://github.com/Pedro-R-Zanini/GabizitaPlayer-Android-TV)**: Reprodutor de mídia nativo otimizado para a interface de telas grandes, lidando com a manipulação direta do ciclo de vida e reprodução no Android TV.
* **[Controle-Suas-Contas-Android](https://github.com/Pedro-R-Zanini/Controle-Suas-Contas-Android)**: App nativo focado em gestão financeira, persistência de dados local e interfaces responsivas.
...
<p align="left">
  <a href="https://www.linkedin.com/in/pedro-zanini" target="_blank">
    <img src="https://img.shields.io/badge/-LinkedIn-%230077B5?style=for-the-badge&logo=linkedin&logoColor=white" target="_blank">
  </a>
  <a href="mailto:pedrozanini2002@gmail.com">
